    ...
    <div class="container mb-5">
        <div class="row px-3">
            <form action="order.php">
                <div class="mb-4">
                    <label for="" class="fw-bold mb-2">الجنسية</label>
                    <select name="" id="" class="form-select" required>
                        <option value="" selected disabled>إختيار الجنسية</option>
                        <option value="">إثيوبيا</option>
                        <option value="">فلبين</option>
                        <option value="">الهند</option>
                        <option value="">سيريلنكا</option>
                        <option value="">بنغلادش</option>
                    </select>
                </div>

                <div class="mb-4">
                    <label for="" class="fw-bold mb-2">باقة الخدمة</label>
                    <select name="" id="" class="form-select" required>
                        <option value="" selected disabled>إختيار الخدمة</option>
                        <option value="">عاملـة منزليـة</option>
                        <option value="">مربية</option>
                        <option value="">سائق خاص</option>
                        <option value="">طباخـة منزليـة</option>
                    </select>
                </div>

                <div class="mb-4">
                    <label for="" class="fw-bold mb-2">تاريخ بدء الخدمة </label>
                    <input type="date" class="form-control" required>
                </div>

                <div class="mb-4">
                    <label for="" class="fw-bold mb-2"> إختيار مدة الخدمة</label>
                    <select name="" id="" class="form-select" required>
                        <option value="" selected disabled>إختيار مدة الخدمة</option>
                        <option value="زيارة منزلية 4 ساعات ( 6 دنانير )" class="R4tv1w" aria-selected="true">زيارة منزلية 4 ساعات ( 6 دنانير )</option>
                        <option value="زيارة منزلية 6 ساعات ( 8 دنانير )" class="R4tv1w" aria-selected="false">زيارة منزلية 6 ساعات ( 8 دنانير )</option>
                        <option value="زيارة منزلية 8 ساعات ( 10 دنانير )" class="R4tv1w" aria-selected="false">زيارة منزلية 8 ساعات ( 10 دنانير )</option>
                        <option value="مقيمة مدة 30 يوم بتكلفة 85 دينار" class="R4tv1w" aria-selected="false">مقيمة مدة 30 يوم بتكلفة 85 دينار</option>
                        <option value="مقيمة مدة 2 شهرين بتكلفة 170 دينار" class="R4tv1w" aria-selected="false">مقيمة مدة 2 شهرين بتكلفة 170 دينار</option>
                        <option value="مقيمة مدة 3 شهور بتكلفة 255 دينار" class="R4tv1w" aria-selected="false">مقيمة مدة 3 شهور بتكلفة 255 دينار</option>
                        <option value="مقيمة مدة 6 شهور بتكلفة 510 دينار" class="R4tv1w" aria-selected="false">مقيمة مدة 6 شهور بتكلفة 510 دينار</option>
                        <option value="مقيمة مدة 1 سنة بتكلفة 800 دينار" class="R4tv1w" aria-selected="false">مقيمة مدة 1 سنة بتكلفة 800 دينار</option>
                        <option value="مقيمة مدة 2 سنة بتكلفة 1300 دينار" class="R4tv1w" aria-selected="false">مقيمة مدة 2 سنة بتكلفة 1300 دينار</option>
                        <option value="سائق خاص مدة 30 يوم بتكلفة 90 دينار" class="R4tv1w" aria-selected="false">سائق خاص مدة 30 يوم بتكلفة 90 دينار</option>
                        <option value="سائق خاص 3 شهور بتكلفة 270 دينار" class="R4tv1w" aria-selected="false">سائق خاص 3 شهور بتكلفة 270 دينار</option>
                        <option value="سائق خاص مدة 6 شهور 540 دينار" class="R4tv1w" aria-selected="false">سائق خاص مدة 6 شهور 540 دينار</option>
                        <option value="سائق خاص اسبوعي مدة 30 دينار" class="R4tv1w" aria-selected="false">سائق خاص اسبوعي مدة 30 دينار</option>
                        <option value="سائق خاص مدة يوم 10 دينار" class="R4tv1w" aria-selected="false">سائق خاص مدة يوم 10 دينار</option>
                    </select>
                </div>

                <div class="mb-4 d-flex justify-content-between align-items-center">
                    <label for="" class="fw-bold mb-2"> ساعة استلام العاملة</label>
                    <select name="" id="" class="form-select w-50" required>
                ...
                <div class="mb-4">
                    <label for="" class="fw-bold mb-2">الجنس</label>
                    <select name="" id="" class="form-select" required>
                ...
                <div class="mb-4">
                    <label for="" class="fw-bold mb-3">يرجى اختيار طريقة الاستلام</label>
                    <div>
